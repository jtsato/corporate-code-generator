...
The multi-module Golden Path has 54 artifacts. `infra.database.domains.<entity>.query` supplies passive Querydsl predicate builders; Q-types are generated by Maven and never committed. REST/runtime integration remains future scope.
