...
| `nestjs-clean-architecture` full profile | 106 CREATE |
...
| `nestjs-clean-architecture --module web-api` | 75 CREATE |
| `nestjs-clean-architecture --module bootstrap` | 90 CREATE |
| `nestjs-clean-architecture --option persistence=typeorm` full profile | 108 CREATE |
| `nestjs-clean-architecture --option persistence=typeorm --module infra-persistence` | 59 CREATE |
| `nestjs-clean-architecture --option persistence=typeorm --module bootstrap` | 92 CREATE |
