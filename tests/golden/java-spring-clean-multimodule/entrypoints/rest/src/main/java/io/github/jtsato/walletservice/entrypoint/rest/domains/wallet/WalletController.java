...
public class WalletController {
    ...
    @Parameter(name = "sort", description = "Sort expression as <field>:<direction>. Repeat to apply multiple orders in order. Fields: id, balance, currency. Directions: asc, desc.", example = "balance:desc", array = @ArraySchema(schema = @Schema(type = "string")))
    @ApiResponses({
