...
public final class WalletQuerydslFilterDefinition {
    ...
    public static QuerydslFilterDefinition create() {
        ...
        return QuerydslFilterDefinition.of(List.of(QuerydslFilterFieldDefinition.of("id", UUID.class, id), QuerydslFilterFieldDefinition.of("balance", BigDecimal.class, balance)));
    }
}
