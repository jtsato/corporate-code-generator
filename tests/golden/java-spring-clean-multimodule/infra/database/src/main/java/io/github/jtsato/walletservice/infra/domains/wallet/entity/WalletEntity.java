...
@Table(name = "wallet", uniqueConstraints = {
    ...
    @UniqueConstraint(name = "uk_wallet_balance_currency_active_scope", columnNames = { "balance", "currency", "deletion_scope" })
})
public class WalletEntity {
    ...
    public WalletEntity(UUID id, BigDecimal balance, String currency) {
        this.id = id;
