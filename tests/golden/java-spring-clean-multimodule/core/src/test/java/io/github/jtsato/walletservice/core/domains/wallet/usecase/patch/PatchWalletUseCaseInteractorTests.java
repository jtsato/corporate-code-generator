...
class PatchWalletUseCaseInteractorTests {
    ...
    void shouldRejectEmptyPatch() {
        var exception = assertThrows(ValidationException.class, () -> new PatchWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), null, false, null, false));
        assertEquals("command", exception.getFields().getFirst().name());
    ...
    void shouldRejectNullIdWhenProvided() {
        var exception = assertThrows(ValidationException.class, () -> new PatchWalletCommand(null, new BigDecimal("124.45"), true, "sample-3", true));
    ...
    void shouldRejectNullBalanceWhenProvided() {
        var exception = assertThrows(ValidationException.class, () -> new PatchWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), null, true, "sample-3", true));
    ...
    @Test
    void shouldRejectNullCurrencyWhenProvided() {
        var exception = assertThrows(ValidationException.class, () -> new PatchWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), new BigDecimal("124.45"), true, null, true));
        assertEquals("currency", exception.getFields().getFirst().name());
        assertEquals("wallet.currency.required", exception.getFields().getFirst().messageKey());
    }
    ...
    void shouldFindMergeAndUpdate() {
        ...
        var result = new PatchWalletUseCaseInteractor(gateway).execute(new PatchWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), new BigDecimal("125.45"), true, "sample-4", true));
        ...
        assertEquals("sample-4", gateway.received.getCurrency());
    ...
    @Test
    void shouldPreserveOmittedBalance() {
        var gateway = new FakeWalletGateway();
        gateway.current = new Wallet(
            UUID.fromString("11111111-1111-1111-1111-111111111111"),
            new BigDecimal("124.45"),
        ...
        gateway.result = gateway.current;
        new PatchWalletUseCaseInteractor(gateway).execute(new PatchWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), null, false, "sample-3", true));
