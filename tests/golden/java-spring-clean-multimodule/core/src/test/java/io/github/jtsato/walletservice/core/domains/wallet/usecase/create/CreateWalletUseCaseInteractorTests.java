...
class CreateWalletUseCaseInteractorTests {
    ...
    void shouldRejectNullIdInCommand() {
        var exception = assertThrows(
            ValidationException.class,
            () -> new CreateWalletCommand(null, new BigDecimal("124.45"), "sample-3")
        );
    ...
    void shouldRejectNullBalanceInCommand() {
        var exception = assertThrows(
            ValidationException.class,
            () -> new CreateWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), null, "sample-3")
        );
    ...
    void shouldRejectNullCurrencyInCommand() {
        var exception = assertThrows(
            ValidationException.class,
            () -> new CreateWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), new BigDecimal("124.45"), null)
        );
    ...
    void shouldCreateAndDelegateWalletPreservingItsValues() {
        ...
        var command = new CreateWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), new BigDecimal("124.45"), "sample-3");
