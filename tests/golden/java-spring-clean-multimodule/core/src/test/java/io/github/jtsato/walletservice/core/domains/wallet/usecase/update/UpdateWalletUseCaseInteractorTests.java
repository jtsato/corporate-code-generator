...
class UpdateWalletUseCaseInteractorTests {
    ...
    void shouldRejectNullCommand() {
        ...
        var exception = assertThrows(
            ...
            () -> new UpdateWalletUseCaseInteractor(gateway).execute(null)
        );
    ...
    void shouldRejectNullIdInCommand() {
        var exception = assertThrows(
            ValidationException.class,
            () -> new UpdateWalletCommand(null, new BigDecimal("124.45"), "sample-3")
        );
    ...
    void shouldRejectNullBalanceInCommand() {
        var exception = assertThrows(
            ValidationException.class,
            () -> new UpdateWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), null, "sample-3")
        );
    ...
    @Test
    void shouldRejectNullCurrencyInCommand() {
        var exception = assertThrows(
            ValidationException.class,
            () -> new UpdateWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), new BigDecimal("124.45"), null)
        );
    ...
    @Test
    void shouldUpdateAndDelegateWalletPreservingItsValues() {
        var gateway = new FakeWalletGateway();
        ...
        var command = new UpdateWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), new BigDecimal("124.45"), "sample-3");

        var result = new UpdateWalletUseCaseInteractor(gateway).execute(command);
        ...
        assertEquals("sample-3", gateway.received.getCurrency());
