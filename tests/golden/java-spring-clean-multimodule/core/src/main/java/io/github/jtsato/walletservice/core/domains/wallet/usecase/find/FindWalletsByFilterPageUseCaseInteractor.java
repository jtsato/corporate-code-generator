...
public final class FindWalletsByFilterPageUseCaseInteractor implements FindWalletsByFilterPageUseCase {
    private final WalletGateway walletGateway;

    public FindWalletsByFilterPageUseCaseInteractor(WalletGateway walletGateway) {
        this.walletGateway = walletGateway;
    }

    @Override
    public PageResult<Wallet> execute(FilterExpression filterExpression, PageRequest pageRequest) {
        ...
        return walletGateway.findByFilterPage(filterExpression, pageRequest);
    }
}
