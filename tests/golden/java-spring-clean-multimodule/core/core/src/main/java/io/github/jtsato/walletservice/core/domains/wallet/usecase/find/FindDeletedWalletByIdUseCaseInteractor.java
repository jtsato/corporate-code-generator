...
public final class FindDeletedWalletByIdUseCaseInteractor implements FindDeletedWalletByIdUseCase {
    private final WalletGateway walletGateway;

    public FindDeletedWalletByIdUseCaseInteractor(WalletGateway walletGateway) {
        this.walletGateway = walletGateway;
    }

    @Override
    public WalletTombstone execute(UUID id) {
        if (id == null) {
        ...
        return walletGateway.findDeletedById(id);
    }
}
