...
class FindDeletedWalletByIdUseCaseInteractorTests {
    ...
    void shouldDelegateIdentifierToGatewayAndReturnItsResult() {
        ...
        var result = new FindDeletedWalletByIdUseCaseInteractor(gateway).execute(identifier);
    ...
    void shouldRejectNullIdentifier() {
        ...
        var exception = assertThrows(
            ...
            () -> new FindDeletedWalletByIdUseCaseInteractor(gateway).execute(null)
        );
