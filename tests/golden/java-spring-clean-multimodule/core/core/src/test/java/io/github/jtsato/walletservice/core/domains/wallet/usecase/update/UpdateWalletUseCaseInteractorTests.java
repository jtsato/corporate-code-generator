...
class UpdateWalletUseCaseInteractorTests {
    ...
    void shouldRejectNullIdInCommand() {
        var exception = assertThrows(
            ValidationException.class,
            () -> new UpdateWalletCommand(null, new BigDecimal("124.45"))
        );
    ...
    void shouldRejectNullBalanceInCommand() {
        var exception = assertThrows(
            ValidationException.class,
            () -> new UpdateWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), null)
        );
    ...
    void shouldUpdateAndDelegateWalletPreservingItsValues() {
        ...
        var command = new UpdateWalletCommand(UUID.fromString("11111111-1111-1111-1111-111111111111"), new BigDecimal("124.45"));
