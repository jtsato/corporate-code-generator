...
class WalletHttpUpdateTests {
    ...
    void shouldUpdateAndPersistWallet() throws Exception {
        ...
        HttpResponse<String> response = put("/wallets/" + WALLET_ID, "{\"balance\":124.45}");
    ...
    void shouldReturnUpdatedWalletWhenFetchedAfterUpdate() throws Exception {
        ...
        assertThat(put("/wallets/" + WALLET_ID, "{\"balance\":124.45}").statusCode()).isEqualTo(200);
    ...
    void shouldReturnNotFoundForMissingWallet() throws Exception {
        assertThat(put("/wallets/" + UUID.fromString("11111111-1111-1111-1111-111111111112"), "{\"balance\":124.45}").statusCode()).isEqualTo(404);
    }
    ...
    void shouldRejectMissingValue() throws Exception {
        assertThat(put("/wallets/" + WALLET_ID, "{}").statusCode()).isEqualTo(400);
    }
    ...
    void shouldRejectInvalidPathIdentifier() throws Exception {
        assertThat(put("/wallets/not-a-uuid", "{\"balance\":124.45}").statusCode()).isEqualTo(400);
    }
