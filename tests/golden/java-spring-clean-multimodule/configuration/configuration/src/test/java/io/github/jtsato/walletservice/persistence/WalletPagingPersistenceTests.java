...
class WalletPagingPersistenceTests {
    ...
    void arrange() {
        ...
        walletRepository.saveAllAndFlush(List.of(
            new WalletEntity(UUID.fromString("11111111-1111-1111-1111-111111111111"), new BigDecimal("123.45")),
            new WalletEntity(UUID.fromString("11111111-1111-1111-1111-111111111112"), new BigDecimal("124.45")),
            new WalletEntity(UUID.fromString("11111111-1111-1111-1111-111111111113"), new BigDecimal("125.45")),
            new WalletEntity(UUID.fromString("11111111-1111-1111-1111-111111111114"), new BigDecimal("126.45")),
            new WalletEntity(UUID.fromString("11111111-1111-1111-1111-111111111115"), new BigDecimal("127.45"))
        ));
    }
