...
class WalletHttpCreateTests {
    ...
    void shouldCreateAndPersistWalletEntity() throws Exception {
        HttpResponse<String> response = post("{\"id\":\"11111111-1111-1111-1111-111111111111\",\"balance\":123.45,\"currency\":\"sample\"}");
        ...
        assertThat(body.path("currency").asText()).isEqualTo(String.valueOf(WALLET_CURRENCY));
    ...
    void shouldRejectDuplicateWalletEntityWithoutOverwritingOriginal() throws Exception {
        ...
        HttpResponse<String> response = post("{\"id\":\"11111111-1111-1111-1111-111111111111\",\"balance\":124.45,\"currency\":\"sample-2\"}");
    ...
    void shouldReuseUniqueValueAfterSoftDelete() throws Exception {
        assertThat(post("{\"id\":\"11111111-1111-1111-1111-111111111111\",\"balance\":123.45,\"currency\":\"sample\"}").statusCode()).isEqualTo(201);
        assertThat(delete("/wallets/" + WALLET_ID).statusCode()).isEqualTo(204);

        HttpResponse<String> response = post("{\"id\":\"11111111-1111-1111-1111-111111111112\",\"balance\":123.45,\"currency\":\"sample\"}");
    ...
    void shouldRejectNullIdentifier() throws Exception {
        assertThat(post("{\"id\":null,\"balance\":123.45,\"currency\":\"sample\"}").statusCode()).isEqualTo(400);
    }

    @Test
    void shouldRejectNullValue() throws Exception {
        assertThat(post("{\"id\":\"11111111-1111-1111-1111-111111111111\",\"balance\":null,\"currency\":\"sample\"}").statusCode()).isEqualTo(400);
    }

    @Test
    void shouldRejectInvalidIdentifier() throws Exception {
        assertThat(post("{\"id\":\"not-a-uuid\",\"balance\":123.45,\"currency\":\"sample\"}").statusCode()).isEqualTo(400);
    }
    ...
    void shouldCreateThenFindByIdentifier() throws Exception {
        HttpResponse<String> created = post("{\"id\":\"11111111-1111-1111-1111-111111111111\",\"balance\":123.45,\"currency\":\"sample\"}");
