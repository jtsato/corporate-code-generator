...
import { CreateWalletCommand } from '@wallet-service/core/usecases/create-wallet/create-wallet.command';
import { DeleteWalletCommand } from '@wallet-service/core/usecases/delete-wallet/delete-wallet.command';
import {
  IDeleteWalletUseCase,
  IDeleteWalletUseCaseSymbol,
} from '@wallet-service/core/usecases/delete-wallet/delete-wallet-usecase.interface';
...
import { PageWalletQuery } from '@wallet-service/core/usecases/page-wallets/page-wallets.query';
import {
  IPageWalletUseCase,
  IPageWalletUseCaseSymbol,
} from '@wallet-service/core/usecases/page-wallets/page-wallets-usecase.interface';
import {
  ICreateWalletUseCase,
  ICreateWalletUseCaseSymbol,
} from '@wallet-service/core/usecases/create-wallet/create-wallet-usecase.interface';
import { PatchWalletCommand } from '@wallet-service/core/usecases/patch-wallet/patch-wallet.command';
import type { PatchWalletChanges } from '@wallet-service/core/usecases/patch-wallet/patch-wallet.changes';
import {
  IPatchWalletUseCase,
  IPatchWalletUseCaseSymbol,
} from '@wallet-service/core/usecases/patch-wallet/patch-wallet-usecase.interface';
import { GetDeletedWalletByIdQuery } from '@wallet-service/core/usecases/get-deleted-wallet-by-id/get-deleted-wallet-by-id.query';
import {
  IGetDeletedWalletByIdUseCase,
  IGetDeletedWalletByIdUseCaseSymbol,
} from '@wallet-service/core/usecases/get-deleted-wallet-by-id/get-deleted-wallet-by-id-usecase.interface';
import { PageDeletedWalletQuery } from '@wallet-service/core/usecases/page-deleted-wallets/page-deleted-wallets.query';
import {
  IPageDeletedWalletUseCase,
  IPageDeletedWalletUseCaseSymbol,
} from '@wallet-service/core/usecases/page-deleted-wallets/page-deleted-wallets-usecase.interface';
import { RestoreWalletCommand } from '@wallet-service/core/usecases/restore-wallet/restore-wallet.command';
import {
  IRestoreWalletUseCase,
  IRestoreWalletUseCaseSymbol,
} from '@wallet-service/core/usecases/restore-wallet/restore-wallet-usecase.interface';
import { GetWalletByIdQuery } from '@wallet-service/core/usecases/get-wallet-by-id/get-wallet-by-id.query';
import {
  IGetWalletByIdUseCase,
  IGetWalletByIdUseCaseSymbol,
} from '@wallet-service/core/usecases/get-wallet-by-id/get-wallet-by-id-usecase.interface';
...
import { UpdateWalletCommand } from '@wallet-service/core/usecases/update-wallet/update-wallet.command';
import {
  IUpdateWalletUseCase,
  IUpdateWalletUseCaseSymbol,
} from '@wallet-service/core/usecases/update-wallet/update-wallet-usecase.interface';
