...
import { ConflictExceptionFilter } from '@wallet-service/web-api/commons/filters/conflict.exception.filter';
import { HealthController } from '@wallet-service/web-api/health/health.controller';
import { I18nModule } from '@wallet-service/web-api/i18n/i18n.module';
import { NotFoundExceptionFilter } from '@wallet-service/web-api/commons/filters/not-found.exception.filter';
import { ValidationExceptionFilter } from '@wallet-service/web-api/commons/filters/validation.exception.filter';
