...
const GENERATED_PATHS = [
  ...
  "src/core/i18n/i18n-service.interface.ts",
  ...
  "src/core/models/wallet-tombstone.model.ts",
  ...
  "src/core/usecases/restore-wallet/restore-wallet.command.ts",
  "src/core/usecases/restore-wallet/restore-wallet.gateway.ts",
  "src/core/usecases/restore-wallet/restore-wallet-usecase.interface.ts",
  "src/core/usecases/restore-wallet/restore-wallet.usecase.ts",
  "src/core/usecases/restore-wallet/restore-wallet.usecase.spec.ts",
  "src/core/usecases/get-deleted-wallet-by-id/get-deleted-wallet-by-id.query.ts",
  "src/core/usecases/get-deleted-wallet-by-id/get-deleted-wallet-by-id.gateway.ts",
  "src/core/usecases/get-deleted-wallet-by-id/get-deleted-wallet-by-id-usecase.interface.ts",
  "src/core/usecases/get-deleted-wallet-by-id/get-deleted-wallet-by-id.usecase.ts",
  "src/core/usecases/get-deleted-wallet-by-id/get-deleted-wallet-by-id.usecase.spec.ts",
  "src/core/usecases/page-deleted-wallets/page-deleted-wallets.query.ts",
  "src/core/usecases/page-deleted-wallets/page-deleted-wallets.gateway.ts",
  "src/core/usecases/page-deleted-wallets/page-deleted-wallets-usecase.interface.ts",
  "src/core/usecases/page-deleted-wallets/page-deleted-wallets.usecase.ts",
  ...
  "src/web-api/i18n/en/messages.json",
  "src/web-api/i18n/pt/messages.json",
  "src/web-api/i18n/language-negotiation.ts",
  "src/web-api/i18n/language-negotiation.spec.ts",
  "src/web-api/i18n/supported-language.resolver.ts",
  "src/web-api/i18n/i18n.module.ts",
  ...
  "src/web-api/commons/filters/conflict.exception.filter.ts",
  ...
  "src/web-api/entrypoints/wallets/wallet-tombstone-response.model.ts",
  "src/web-api/entrypoints/wallets/wallet-tombstone-presenter.mapper.ts",
  ...
  "src/web-api/entrypoints/wallets/wallet-tombstone-page-response.model.ts",
