...
describe("Java multi-module profile foundation", () => {
  ...
  it("resolves the multi-module template pack and its modules deterministically", async () => {
    ...
    expect(templatePack.templatePack.templates.map((template) => template.id)).toEqual([
      ...
      "build-run-script-posix",
      "build-run-script-windows",
      "build-smoke-requests",
      "core-domain-entity",
      "core-domain-tombstone",
      "core-gateway",
      "core-create-command",
      "core-create-usecase",
      ...
      "core-patch-command",
      "core-patch-usecase",
      "core-patch-usecase-interactor",
      "core-patch-usecase-interactor-test",
      "core-delete-command",
      "core-delete-usecase",
      ...
      "core-restore-usecase-interactor",
      "core-restore-usecase-interactor-test",
      "core-find-usecase",
      ...
      "core-find-deleted-usecase-by-id",
      "core-find-deleted-usecase-by-id-interactor",
      "core-find-deleted-usecase-by-id-interactor-test",
      ...
      "core-find-deleted-usecase-by-filter-page",
      "core-find-deleted-usecase-by-filter-page-interactor",
      "core-find-deleted-usecase-by-filter-page-interactor-test",
      ...
      "entrypoints-rest-controller-test",
      ...
      "entrypoints-rest-domain-patch-request",
      ...
      "infra-database-gateway-provider-test",
      "infra-database-gateway-provider-test-fixture",
      "infra-database-gateway-provider-integration-test",
      "infra-database-test-application",
      ...
      "configuration-layer-dependency-architecture-test",
      "configuration-framework-isolation-architecture-test",
      "configuration-package-structure-architecture-test",
      "configuration-global-exception-handler-test",
      "configuration-locale-negotiation-test",
      "configuration-cors-smoke-test",
      "configuration-openapi-smoke-test",
      "configuration-http-smoke-test",
      "configuration-actuator-health-smoke-test",
