...
| 6.45 | Docker Capability | Planned | Generate a multi-stage `Dockerfile`, `.dockerignore`, and Compose file with non-root runtime and healthcheck. | [Wallet Reference Gap Plan](docs/project/WALLET-REFERENCE-GAP-PLAN.md) |
| 6.46 | i18n Policy Completion | Planned | Generate an explicit default locale, supported-locale allowlist, fallback policy, and locale-negotiation coverage. | [Wallet Reference Gap Plan](docs/project/WALLET-REFERENCE-GAP-PLAN.md) |
| 6.47 | ArchUnit Suite Split | Planned | Split the generated architecture suite by rule family without adopting frozen rules. | [Wallet Reference Gap Plan](docs/project/WALLET-REFERENCE-GAP-PLAN.md) |
| 6.48 | Mutation Testing Capability | Planned | Add opt-in PIT configuration targeting generated use-case interactors, excluded from every-push CI. | [Wallet Reference Gap Plan](docs/project/WALLET-REFERENCE-GAP-PLAN.md) |
| 6.49 | Testcontainers Verification | Planned | Add an opt-in database integration profile for the generated project. | [Wallet Reference Gap Plan](docs/project/WALLET-REFERENCE-GAP-PLAN.md) |
| 6.50 | Developer Run Scripts and Smoke Requests | Planned | Add opt-in developer convenience scripts and an HTTP request collection. | [Wallet Reference Gap Plan](docs/project/WALLET-REFERENCE-GAP-PLAN.md) |
| 6.51 | Generated Coverage Threshold Gate | Planned | Add the JaCoCo `check` rule at `verify` once module-local tests have raised per-module coverage. Deferred from 6.39. | [ADR-060](docs/adr/ADR-060-generated-coverage-reporting.md) |
