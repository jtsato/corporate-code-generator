...
| 6.44 | Generated CI Hardening | Planned | Pin actions by commit SHA, cache Maven, add `workflow_dispatch`, and gate an optional analysis step on secret presence. | [Wallet Reference Gap Plan](docs/project/WALLET-REFERENCE-GAP-PLAN.md) |
