    ...
    expect(artifacts.slice(0, 2)).toMatchObject([
      {
        ...
        model: {
          ...
          useCaseType: "FindWalletsByFilterUseCase",
          useCaseFieldName: "findWalletsByFilterUseCase",
          ...
          "io.github.jtsato.walletservice.core.domains.wallet.usecase.find.FindWalletsByFilterUseCase",
