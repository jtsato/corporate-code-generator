export interface JavaPersistenceMapperTemplateModel {
  ...
  readonly toEntityMethodName: string; readonly toDomainMethodName: string; readonly toTombstoneMethodName: string; readonly toEntityArguments: readonly string[]; readonly toDomainArguments: readonly string[]; readonly toTombstoneArguments: readonly string[];
